// Bar Chart: Medals over the years
    ...
    "Розширення співпраці з міжнародними оборонними партнерами",
    "Розробка спільних стратегічних програм у сфері оборони",
    "Проведення двосторонніх і багатосторонніх навчань з країнами-партнерами",
    "Організація тренувальних місій для підвищення кваліфікації військових",
    "Ініціативи щодо інтеграції України у міжнародні оборонні структури",
    "Підтримка військовослужбовців через спільні проєкти з країнами-партнерами",
    "Розробка програм військово-технічного співробітництва",
    "Проведення конференцій і форумів з питань міжнародної безпеки",
    "Залучення міжнародного досвіду для реформування оборонного сектору",
    "Популяризація досягнень українських військових на міжнародній арені"
];
